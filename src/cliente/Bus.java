...
import jojeda.compartido.Constantes;
...
public class Bus {
    ...
    public Bus() {
        try {
            // Se conecta
            Socket clientSocket = new Socket(Constantes.SERVER_IP, Constantes.SERVER_PORT);
...
//                System.out.println("Parada actual: " + ultima.getNombreBus());
//                System.out.println("Siguiente: " + siguiente.getNombreBus());
//                System.out.println("Ruta calculada: (" + ruta.getX() + ", " + ruta.getY() + ")");
                double distancia;
